...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--src', default='./ffhq_sample', help='directory of raw images')
    parser.add_argument('-d', '--dst', default='./aligned_ffhq', help='directory of aligned images')
    ...
    if not os.path.exists(args.dst):
        os.mkdir(args.dst)
    landmarks_detector = face_alignment.FaceAlignment(face_alignment.LandmarksType._3D, device='cpu',flip_input=False)
